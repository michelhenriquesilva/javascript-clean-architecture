...
test("Should enter parking lot", async function(){
    ...
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-04-17T10:00:00"))
...
test.skip("Should be full parking lot", async function(){
    const parkingLotRepositoryMemory = new ParkingLotRepositoryMemory();
    const enterParkingLot = new EnterParkingLot(parkingLotRepositoryMemory)
    const getParkingLot =  new GetParkingLot(parkingLotRepositoryMemory)
    ...
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-04-17T10:00:00"))
    await enterParkingLot.execute("shopping", "MMM-0002", new Date("2021-04-17T10:00:00"))
    await enterParkingLot.execute("shopping", "MMM-0003", new Date("2021-04-17T10:00:00"))
    await enterParkingLot.execute("shopping", "MMM-0004", new Date("2021-04-17T10:00:00"))
    await enterParkingLot.execute("shopping", "MMM-0005", new Date("2021-04-17T10:00:00"))
    await enterParkingLot.execute("shopping", "MMM-0006", new Date("2021-04-17T10:00:00"))
